...
<html>
    ...
    <body>
                    ...
                    <div id="openModal" class="modalDialog">
                        <div>
                            ...
                            <form id="add" name="adduser" action="AddUSer">
                                <h2>My Profile</h2>
                                <img id= "icon" src="res/emp.png" width="150px" style="margin-left: 130px;">
                                <table border="0">
                    ...
                    <div id="openModal1" class="modalDialog">
                        <div>
                            ...
                            <form id="add" name="adduser" action="User/saveprofile_1.jsp">
                                <h2>Edit Profile</h2>
                                <img id= "icon" src="res/emp.png" width="140px" style="margin-left: 130px;" >
                                <table border="0">
                                    <tbody>
                                    ...
                                    <tr>
                                        <td>Gender</td>
                                        <td><input type="radio" name="igender" value="Male" style="margin-left: 40px;" <%=male%> />Male <input type="radio" name="igender" value="Female" <%=female%> />Female</td>
                                    </tr>
                                    <tr>
                                        <td>NIC No</td>
                                    ...
                                    <tr>
                                        <td>Address</td>
                                        <td><textarea name="iaddress" rows="4" cols="32"  style="margin-left: 40px;">
                                                <%=address%>
                                            </textarea></td>
                                    </tr>
                                    <tr>
                    ...
                    <div id="openModal21" class="modalDialog">
                        <div>
                            ...
                            <form id="add" name="adduser" action="AddUSer">
                                ...
                                <img id= "icon" src="res/sal.png" width="100px" style="margin-left: 160px;">
            ...
            <li><a href="#">Paysheet Option</a>
                <ul>
                    ...
                    <div id="openModal31" class="modalDialog">
                        <div>
                            <a href="#close" title="Close" class="close">X</a>
                            <form id="add" name="adduser" action="User/userpaysheet.jsp">
        ...
        <div id="firstlogin" class="modalDialog">
            <div>
                <form id="add" name="adduser" action="User/saveprofile.jsp">
                    ...
                    <img id= "icon" src="res/emp.png" width="140px">
        ...
        <div id="complete" class="modalDialog">
            <div>
                <a href="#close" title="Close" class="close">X</a>
                <img id= "icon" src="res/kk.png" width="100px" style="margin-left: 175px;">
                <br>
                <h4 style="color: white; text-align: center;">The operation completed successfully!</h4>
        ...
        <div id="error" class="modalDialog">
            <div>
                <a href="#close" title="Close" class="close" >X</a>
                <img id= "icon" src="res/cacel.png" width="100px" style="margin-left: 175px;">
                <br>
                <h4 style="color: white; text-align: center;"> Error. Operation Fail! </h4>
                <%-- <%response.setHeader("Refresh", "2;url=#close");%> --%>
            </div>
        </div>
        <div id="exception" class="modalDialog">
            <div>
                <a href="#close" title="Close" class="close">X</a>
                <img id= "icon" src="res/cacel.png" width="100px" style="margin-left: 175px;">
                <h3 style="color: white; text-align: center;">Exception!.</h3>
                <%--   <h5> <%= session.getAttribute("exMsg")%></h5>
                <%response.setHeader("Refresh", "2;url=#close");%>  --%>
            </div>
        </div>
